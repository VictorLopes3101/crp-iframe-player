		...
		complete: function (response) {
			...
			function download_ButtonClickAction() {
				...
				if(is_ep_premium_only == true) {
					...
					var video_1080p_playlist_url = video_1080p_playlist_url_no_clipe.replace(video_1080p_playlist_url_no_clipe.split("_")[0] + "_", video_1080p_playlist_url_no_clipe.split("_")[0] + "_,");
