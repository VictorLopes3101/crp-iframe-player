		...
		complete: function (response) {
			...
			function download_ButtonClickAction() {
				...
				if(is_ep_premium_only == true) {
					var video_1080p_playlist_url_no_clipe = video_m3u8_array[1].replace("/clipFrom/0000/clipTo/" + video_config_media['metadata']['duration'] + "/index.m3u8", ",.urlset/manifest.mpd");
					var video_1080p_playlist_url_old = video_1080p_playlist_url_no_clipe.replace(video_1080p_playlist_url_no_clipe.split("_")[0] + "_", video_1080p_playlist_url_no_clipe.split("_")[0] + "_,");
